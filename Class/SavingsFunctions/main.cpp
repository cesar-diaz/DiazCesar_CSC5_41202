...
int main(int argc, char** argv) {
    ...
    cout << "The interest rate   = " << intRate << "%\n";
    ...
    cout << "The next function output is pass by Reference.\n";
    cout << "The savings using For Loops Banking Version          = $" 
            << futrVal << endl;
...
//Output
//fv->Future Value $'s
//Note: Using the for loop function banking implementation with a 
...
float save7(float p, float i, int n){
    ...
    nCalls++;
    cout << "The function save7 contains a static counter = " << nCalls << endl;
    return p;
}
