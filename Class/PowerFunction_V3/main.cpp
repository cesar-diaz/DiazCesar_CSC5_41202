/* 
    ...
    Purpose: Power Function Example, using pass by reference with const
 */
...
int main(int argc, char** argv) {
    ...
    int begi, endi, begd, endd, loop = 800000000;//Beginning and ending of the integer vs. double 
    ...
    //Input data
    cout << "Input a and b i.e. for a^b\n";
    cin >> x >> y;
    ...
    //Output the results
    cout << "The functions are called " << loop << " times.\n";
    ...
    //Output the results
    cout << "Library function result: " << dx << "^" << dy << " = " << dz 
            << endl;
