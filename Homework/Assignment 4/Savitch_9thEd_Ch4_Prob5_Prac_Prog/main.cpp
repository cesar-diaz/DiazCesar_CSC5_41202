...
int main(int argc, char** argv) {
    ...
    //Calculate price of item in 1 and 2 yrs. from now
    cout << "If the interest continues at " << rate << " the cost of the item "
            "will be:\n";
    nowPrice =  nowPrice + (nowPrice * rate);
    cout << "In 1 year the price will be:  $" << nowPrice << endl;
    nowPrice =  nowPrice + (nowPrice * rate);    
    cout << "In 2 years the price will be: $" << nowPrice << endl;
